     ...
     <button className="navbar-toggler bg-dark" type="button" data-toggle="collapse" data-target="#navbarNav"
      ...
      <div className="collapse navbar-collapse" id="navbarNav">
          <ul className="navbar-nav  d-flex  align-items-center justify-content-center ">
                 ...
                 <li className="nav-item">
                   <Link className="nav-nome text-white  nav-link  mx-4" to="/nossaslojas">Nossas lojas</Link>
                 </li>

                 <li className="nav-item">
                    <Link className="nav-nome text-white nav-link  mx-4" to="/contato">Deixe um comentário</Link>
                </li>
